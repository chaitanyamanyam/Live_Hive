  ...
  while($stmt1->fetch())
    {
      ...
      echo"<tr><td>Artist Name:<a href='artist_profile.php?pname=".$r1_uname."&r=".$d."'>$r1_uname</a> </td>";
...
(SELECT username,concert_name from rsvp_info)as k1 on k.c=k1.concert_name and k1.username=? LIMIT 5" );
